<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edituser.aspx.cs" Inherits="saumya_project.Edituser" %>
...
h4{
    ...
    <td colspan="2" class="cell">
        ...
        <asp:Button ID="Button1" runat="server" OnClick="btnUpdate" Text="Update" />
